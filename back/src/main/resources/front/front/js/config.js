...
var centerMenu = [
    ...
    ,{
        name: '项目收藏',
        url: '../xiangmuCollection/list.html'
    }
    ,{
        name: '保险参保',
        url: '../xiangmuYuyue/list.html'
    }
    ,{
        name: '养老政策收藏',
        url: '../zhengceCollection/list.html'
    }
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/yanglaobapxianguanlixit/admin/dist/index.html#/login";
