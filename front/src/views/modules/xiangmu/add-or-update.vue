        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="保险类型" prop="xiangmuTypes">
                        <el-select v-model="ruleForm.xiangmuTypes" :disabled="ro.xiangmuTypes" placeholder="请选择保险类型">
                            <el-option
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="金额" prop="xiangmuNewMoney">
                       <el-input v-model="ruleForm.xiangmuNewMoney"
                                 placeholder="金额" clearable  :readonly="ro.xiangmuNewMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="金额" prop="xiangmuNewMoney">
                           <el-input v-model="ruleForm.xiangmuNewMoney"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="缴费年数" prop="xiangmuJiaofei">
                       <el-input v-model="ruleForm.xiangmuJiaofei"
                                 placeholder="缴费年数" clearable  :readonly="ro.xiangmuJiaofei"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.xiangmuContent"  label="项目介绍" prop="xiangmuContent">
        ...
        data() {
            return {
                ...
                ro:{
                    ...
                    xiangmuPhoto: false,
                    xiangmuTypes: false,
                    xiangmuNewMoney: false,
                    xiangmuJiaofei: false,
                ...
                rules: {
                   ...
                   xiangmuJiaofei: [
                              { required: true, message: '缴费年数不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
